package com.zlt.seniorpersonnel.dao.base;
...
/**
 * 
 * @Package: om.dmall.homvee.dao.base 
 * @ClassName: BaseDao 
 * @Description: dao基类<实体,主键>
 * @param <T> 实体
 * @param <KEY> 主键
 * @date: 2015年11月14日
 *
...
public interface BaseDao<T,KEY extends Serializable> {
	 ...
	 * @email:Hongwei.Tang@DMall.com
	 */
	List<T> queryEntryListByKey(KEY...keys);
